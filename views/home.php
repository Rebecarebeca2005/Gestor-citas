    ...
    <section class="hero">
        <article class="hero-contenido">
            ...
            <div class="hero-botones">
                <button class="boton1" onclick="location.href='index.php?pagina=register'">Crear cuenta</button>
                <button class="boton2" onclick="location.href='index.php?pagina=login'">Iniciar sesión</button>
            </div>
        ...
        <div class="slider-contenedor">
            ...
            <div class="slide activo">
                <div class="slide-texto">
                    ...
                    <button class="boton1" onclick="location.href='index.php?pagina=register'">Empezar ahora</button>
                </div>
            ...
            <div class="slide">
                <div class="slide-texto">
                    ...
                    <button class="boton2" onclick="location.href='index.php?pagina=login'">Ver más</button>
                </div>
            ...
            <div class="slide">
                <div class="slide-texto">
                    ...
                    <button class="boton1" onclick="location.href='index.php?pagina=register'">Probar</button>
                </div>
