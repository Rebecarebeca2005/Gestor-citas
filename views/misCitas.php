...
<head>
    ...
    <meta
        name="description"
        content="Consulta todas tus citas desde el calendario y visualiza la información de cada reserva de forma sencilla.">

    <meta
        name="keywords"
        content="mis citas, reservas, calendario citas, gestión reservas, citas online">
        ...
        <section class="hero-calendario">
            ...
            <div class="hero-info">
                ...
                <p>
                    ...
                    visualizar las reservas fácilmente.
                </p>
