...
/*
    ...
    para permitir eliminar una cita.
*/
function renderCalendarioEliminar() {
    ...
    for (let i = 1; i <= diasMes; i++) { //Recorremos todos los días del mes
        ...
        if (esPasado) { //Si pertenece al pasado...
            ...
            div.onclick = () => abrirCitasDelDia(fecha); //Si es válido, permite consultar las citas para eliminarlas
        }
...
/*
    ...
    y eliminar las citas asociadas.
*/
renderCalendarioEliminar();